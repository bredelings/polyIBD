...
RcppExport SEXP _polyIBD_stgIrunMCMC_cpp(SEXP argsSEXP, SEXP args_functionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type args(argsSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type args_functions(args_functionsSEXP);
    rcpp_result_gen = Rcpp::wrap(stgIrunMCMC_cpp(args, args_functions));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_polyIBD_stgIrunMCMC_cpp", (DL_FUNC) &_polyIBD_stgIrunMCMC_cpp, 2},
