...
m1 <- 2 # this is the multiplicity of infection for sample1 that we are trying to infer
m2 <- 2 # this is the multiplicity of infection for sample2 that we are trying to infer
m_true <- c(m1, m2)
